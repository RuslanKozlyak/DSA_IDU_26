"""Проверка одного ноутбука лабораторной работы в Pull Request."""
...
LABS = {
    "lab1_complexity/lab1.ipynb": "SEARCHES =",
    "lab2_sorting/lab2.ipynb": "INT_SORTS =",
    "lab3_structures/lab3.ipynb": "LISTS =",
    "lab4_strings/lab4.ipynb": "SEARCHES =",
}
FORBIDDEN_NAMES = {
    "reference.py",
...
def main() -> None:
    ...
    if len(notebooks) != 1:
        fail("PR должен изменять ровно один ноутбук лабораторной работы")
