...
| Работа | Тема | Ноутбук |
|---|---|---|
| 1 | Анализ сложности алгоритмов | `lab1_complexity/lab1_student.ipynb` |
| 2 | Алгоритмы сортировки | `lab2_sorting/lab2_student.ipynb` |
| 3 | Структуры данных и хеширование | `lab3_structures/lab3_student.ipynb` |
| 4 | Алгоритмы поиска подстроки | `lab4_strings/lab4_student.ipynb` |
...
Откройте соответствующий `labN_student.ipynb`, реализуйте задания, выполните все ячейки и сохраните ноутбук вместе с результатами проверок и графиками.

Добавляйте в коммит только ноутбук текущей работы:

```bash
git add lab1_complexity/lab1_student.ipynb
...
- Меняется только `labN_student.ipynb` этой работы.
